...
class EventNotificationStandardErrorTest extends EventNotificationsTemplate {
  static String type = "STDERR";
  static String name = "standard_error_curl";

  public EventNotificationStandardErrorTest() {
    super(type, name);
  }
