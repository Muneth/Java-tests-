...
import static com.atempo.TestTags.APP_NDMP;
...
@Tag(LINUX_AGENT)
@Tag(APP_NDMP)
class BackupSelectionAppNdmpLinuxTest extends AbstractBackupSelectionTest {
  ...
  String getRetrieveOrCreateApp() {
    return AgentsResourceTest.retrieveOrCreateAppNDMP();
  }
